...
if(!mx.skins.halo.RectBorder)
{
   ...
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().getBorderMetrics = function(Void)
   {
   ...
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().drawBorder = function(Void)
   {
   ...
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().draw3dBorder = function(c1, c2, c3, c4, c5, c6)
   {
      var _loc3_ = this.__get__width();
   ...
   mx.skins.halo.RectBorder = function()
   {
      super();
   ...
   {
      super();
   }.symbolOwner = mx.skins.halo.RectBorder;
   mx.skins.halo.RectBorder = function()
   {
      super();
   }.version = "2.0.2.123";
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().borderCapColorName = "borderCapColor";
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().shadowCapColorName = "shadowCapColor";
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().colorList = {highlightColor:0,borderColor:0,buttonColor:0,shadowColor:0,borderCapColor:0,shadowCapColor:0};
   mx.skins.halo.RectBorder.prototype = new mx.skins.RectBorder().borderWidths = {none:0,solid:1,inset:2,outset:2,alert:3,dropDown:2,menuBorder:2,comboNonEdit:2};
   mx.skins.halo.RectBorder = function()
   {
      super();
   }.classConstructed = mx.skins.halo.RectBorder.classConstruct();
   mx.skins.halo.RectBorder = function()
   {
      super();
   }.UIObjectExtensionsDependency = mx.core.ext.UIObjectExtensions;
   §§push(ASSetPropFlags(mx.skins.halo.RectBorder.prototype,null,1));
}
§§pop();
