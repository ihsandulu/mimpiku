class mx.video.UIManager
{
   ...
   function handleEvent(e)
   {
      ...
      var _loc7_ = this._vc.__get__activeVideoPlayerIndex();
      ...
      else if(e.type == "playheadUpdate" && this.controls[mx.video.UIManager.SEEK_BAR] != undefined)
      {
         if(!this._vc.__get__isLive() && this._vc.__get__totalTime() > 0)
         {
            ...
            var _loc8_ = this.controls[mx.video.UIManager.SEEK_BAR];
            _loc8_.percentage = _loc6_;
      ...
      this._vc.__set__activeVideoPlayerIndex(_loc7_);
   }
   ...
   function __get__controlsEnabled()
   {
      return this._controlsEnabled;
   }
   function __set__controlsEnabled(flag)
   {
   ...
   function __get__bufferingDelayInterval()
   {
      return this._bufferingDelayInterval;
   }
   function __set__bufferingDelayInterval(s)
   {
   ...
   {
      var _loc2_ = this.controls[index];
      if(_loc2_ == undefined)
      {
         return undefined;
      }
      ...
      this._vc.__set__activeVideoPlayerIndex(this._vc.visibleVideoPlayerIndex);
      _loc2_.id = index;
      _loc2_.state = mx.video.UIManager.UP_STATE;
      _loc2_.uiMgr = this;
      this.setEnabledAndVisibleForState(index,this._vc.__get__state());
   ...
   function layoutSkin()
   {
      ...
      else
      {
         ...
         {
            this.videoLeft = this.videoLeft - (this.layout_mc.minWidth - this.videoRight) / 2;
         ...
         {
            this.videoTop = this.videoTop - (this.layout_mc.minHeight - this.videoBottom) / 2;
