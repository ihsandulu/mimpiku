class mx.core.ExternalContent
{
   ...
   function waitForUnload()
   {
      ...
      for(var _loc3_ in this.prepList)
      {
         ...
         if(_loc2_.obj.getBytesTotal() == 0)
         {
            ...
            delete this.prepList.register3;
   ...
   function checkLoadProgress()
   {
      var _loc8_ = false;
      var _loc3_ = undefined;
      for(var _loc3_ in this.loadList)
      {
         ...
         if(_loc2_.total > 0)
         {
            ...
            if(_loc2_.loaded == _loc2_.total)
            {
               ...
               delete this.loadList.register3;
         ...
         else if(_loc2_.total == -1)
         {
            ...
            {
               _loc2_.failedOnce = _loc2_.failedOnce + 1;
