class mx.events.UIEventDispatcher extends mx.events.EventDispatcher
{
   ...
   function __addEventListener(event, handler)
   {
      ...
      for(var _loc5_ in _loc3_)
      {
         if(mx.events.UIEventDispatcher[_loc5_][event] != undefined)
         {
            ...
            mx.events.UIEventDispatcher.register2(this);
         }
      }
   }
      ...
      if(this[_loc6_].length == 0)
      {
         ...
         for(var _loc5_ in _loc2_)
         {
            if(mx.events.UIEventDispatcher[_loc5_][event] != undefined)
            {
               ...
               this[_loc2_[_loc5_][1]].call(this,this);
            }
         }
      }
   }
   static function addKeyEvents(obj)
   {
      if(obj.keyHandler == undefined)
      {
         ...
         obj.keyHandler = new Object().owner = obj;
         obj.keyHandler = new Object().onKeyDown = mx.events.UIEventDispatcher._fEventDispatcher.onKeyDown;
         obj.keyHandler = new Object().onKeyUp = mx.events.UIEventDispatcher._fEventDispatcher.onKeyUp;
      }
