				...
				<div class="form-login  fontstandard" style="padding-left:30px; padding-right:30px; margin-top:30px;" align="left">
					<form method="post">
						...
						<div class="form-group">
							...
							<input class="form-control inputstandard" type="text" id="customer_email" name="customer_email" placeholder="Email" required="required" />
						</div>
						<div class="form-group">
							<label for="customer_password">Password:</label>
							<input class="form-control inputstandard" type="password" id="customer_password" name="customer_password" placeholder="Password" required="required" />
						</div>
						<button type="submit" class="btn btn-primary btn-block btn-large inputstandard">Let me in.</button>
					</form>	
					<br/>	
					<div class="back">	
						<span class="fas fa-user-plus"></span> <a href="<?=site_url("register");?>" type="submit" class="">Daftar Disini</a>
					</div>
				</div>
			</div>
