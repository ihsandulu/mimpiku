...
<html>
	...
	<div class="container-fluid" id="fh5co-image-grid" style="padding-top:70px;">
		...
		<div class="grid">
		  ...
		  $hasil1='href="'.site_url("tafsir/".$this->uri->segment(2)."/".$uri).'"';
		  ...
		  ?>
		    <a <?=$hasil;?>>
				<div class="img-wrap" style="border:#AB0C8F dashed 1px; border-radius:5px;">
					<img src="<?=base_url("assets/images/abjad/".$this->uri->segment(2).".jpg");?>" alt="" class="img-responsive" style="opacity:0.1;">
					<div class="tengah">
