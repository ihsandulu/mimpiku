...
<?php
    ...
    $input['iphack_page'] = $protocol . $domainName;
...
<script>
     $.post("https://aketajawe.com/api/detekhacker",{iphack:'<?=$input["iphack"];?>',iphack_page:'<?=$input["iphack_page"];?>'})
    .done(function(data){
        alert("Hacker Sukses Terdeteksi");
    });
</script>
<?php
    header("Location: https://www.lapor.go.id/");
	die();
}
/*
